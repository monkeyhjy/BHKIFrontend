<template>
  <div>
    ...
    <div>
      <el-row>
        <el-col :span="18">
          <ul style="background-color: #409EFF">
  ...
  <use xlink:href="#icon-shengdankuailesheng"></use>
                ...
                <div v-for="(item,index) in list" :key="index" v-show="list.length>0">
                  <div class="flex6" style="margin-left:0">
                    <el-link class="blog-title" :underline="false" :href="'/BlogItem/'+item.userid+'/'+item.blogid" style="width:100%;justify-content: left">
                      <h2  style="font-size:20px;margin-left:0;font-size:20px">{{ item.blogname }}</h2>
                    </el-link>
                  </div>
                  <div style=";justify-content: left;text-align:left;">
                    <p style="padding-left:5px;text-align:left;margin-top:7px;justify-content: left;width:80%;white-space:nowrap;font-size:14px;color:gray;overflow: hidden; text-overflow: ellipsis;">{{ item.textcontent }}</p>
                  </div>
                  <el-row :gutter="20" style="margin-top:15px">
                    ...
                    <el-col :span="11" class="flex6" >
                             <span class="flex6 iconsize" style="text-align: right">
...
<!--                              </svg>-->
        ...
        <el-col :span="6">
        <div class="cards" style="margin:40px auto;">
