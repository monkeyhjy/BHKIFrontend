            ...
            <main style="text-align: center">
                ...
                <div style="margin-top: 20px">
                    <dl>
                        ...
                        <el-input placeholder="请输入关键词" v-model="input" class="input-with-select" style="width: 60%;margin-bottom: 20px">
                        ...
                        <el-select v-model="select3" slot="prepend" placeholder="请选择" class="object_select"  style="width: 88px;margin-bottom: 20px;margin-left: 10px">
                    ...
                    <dd>
                        <el-select v-model="select2" slot="prepend" placeholder="请选择" class="object_select"  style="width: 88px;margin-bottom: 20px;margin-right: 10px">
                        ...
                        <el-select v-model="select4" slot="prepend" placeholder="请选择" class="object_select"  style="width: 88px;margin-left: 10px">
...
<!--                    </el-input>-->
                ...
                <el-row v-if="paper_boolen || author_boolen" style="margin-bottom: 45px">
                    <el-col :span="4"><div style="height: 40px"></div></el-col>
                    <el-col :span="16">
                        <div class="search_result" >
                            <el-tabs type="border-card" style="background-color: rgb(240,241,244);  border-radius: 10px;margin-top: 20%">
