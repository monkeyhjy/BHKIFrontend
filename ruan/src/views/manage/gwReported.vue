<template>
  ...
  <aside class="flex flex-col text-indigo-100 bg-indigo-900 bg-opacity-50" style="width:100px">
    <nav class="text-sm md:text-xs">
      <a href="./blogreported" class="flex flex-col items-center p-4 md:p-6 font-medium tracking-wider hover:bg-indigo-900" style="width:100px">
      ...
      <a href="#" class="flex flex-col items-center p-4 md:p-6 font-medium tracking-wider bg-indigo-800">
