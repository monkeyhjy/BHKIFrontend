  ...
  <div class="flex bg-indigo-800 antialiased min-h-screen">
    <aside class="flex flex-col text-indigo-100 bg-indigo-900 bg-opacity-50" style="width:100px">
      <nav class="text-sm md:text-xs">
        <a href="#" class="flex flex-col items-center p-4 md:p-6 font-medium tracking-wider bg-indigo-800" style="width:100px">
          <img src="../img/document.png" style="margin:10px">
          违规帖子
        </a>
        <a href="./commentreported" class="flex flex-col items-center p-4 md:p-6 font-medium tracking-wider hover:bg-indigo-900" >
          <img src="../img/comment.png" style="margin:10px" >
          违规评论
        </a>
        <a href="./gwreported" class="flex flex-col items-center p-4 md:p-6 font-medium tracking-wider hover:bg-indigo-900">
          <img src="../img/globe_3.png" style="margin:10px">
          冒领门户
        </a>
    ...
    <main class="hidden md:flex flex-col  p-4 md:p-8 bg-gray-200" style="background:white">
      ...
      <div class="flex flex-wrap items-center -mb-4 pt-4 md:pt-8 justify-end ">
        ...
        <el-button type="primary" @click="open">删帖</el-button>
